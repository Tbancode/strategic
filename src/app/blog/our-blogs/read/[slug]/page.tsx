...
} from '@/app/blog/featured-posts/read/[slug]/styles';
    ...
    <PostDetailsWrapper>
      ...
      <DetailsHeadingSection>
        ...
        <AuthorDetails>
          <AuthorImage>
            <Image
              src={data?.blog_author?.author_image_url}
              alt={data?.blog_author?.author_image?.alt}
              fill
            />
          </AuthorImage>
          <AuthorName>
            <h4>{data?.blog_author?.name}</h4>
            <p>
        ...
        <BlogMainImageCtn>
          ...
          <Link
            href={data?.mainImage?.attribution_url ?? ''}
            target="_blank"
            rel="noreferrer noopener"
          >
            {data?.mainImage?.attribution}
          </Link>
        </BlogMainImageCtn>
      </DetailsHeadingSection>
      <ArticleSection>
